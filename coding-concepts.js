...
// b) Verify and explain: const weekendDays = "saturday, sunday" for the console.log(weekendDays.toUpperCase()) the method toUppercase returns the calling string value to uppercase not the array.
